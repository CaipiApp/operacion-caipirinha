...
<button
	on:click={back}
	class="text-gray-600 dark:text-gray-400 dark:hover:text-white hover:text-gray-900"
>
	<svg fill="currentColor" {width} {height} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
		<path
